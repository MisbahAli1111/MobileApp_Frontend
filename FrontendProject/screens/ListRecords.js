      ...
      <View style={{ top: screenWidth * 0.32, width: screenWidth * 0.9, alignSelf: 'center' }}>
        <View style={{ position: 'absolute', flexDirection: 'row', gap: screenWidth * 0.13 }}>
          ...
          <View style={{ gap: screenWidth * 0.01, flexDirection: 'row' }}>
            ...
            <Text style={{ fontSize: rem * 0.60, fontWeight: 500, color: "#6ba2f2" }} >/</Text>
            <TouchableOpacity
              onPress={() => navigation.navigate("Invoices")}
            >
            <Text style={{ fontSize: rem * 0.60, fontWeight: 500, color: "#6ba2f2" }}>Invoices</Text>
            </TouchableOpacity>
            <Text style={{ fontSize: rem * 0.60, fontWeight: 500, color: "black", maxWidth: screenWidth * 0.59 }} numberOfLines={1}>/ Search Records</Text>
